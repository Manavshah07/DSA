...
// BRUTE FORCE APPROACH WITH TIME COMPLEXITY AS O(N) AND SPACE COMPLEXITY AS O(1)
class Solution {
    public List<Integer> findAnagrams(String s, String p) {
        ...
        // HERE WE CREATE A FREQUENCY ARRAY OF SIZE 26 TO STORE CHRACTER FROM A TO Z
        // FROM STRING P
        ...
        // HERE WE EXTRACT SUBSTRINGS OF LENGTH K AND IT WILL STORE LETTERS FROM START
        // INTO THE STRING sub
...
// OPTIMAL APPROACH WITH TIME COMPLEXITY AS O(N) AND SPACE COMPLEXITY AS O(1)
// because map holds at most 26 letters
