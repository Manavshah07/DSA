...
class Solution2 {
    public int TotalPairs(int[] nums, int k) {
        ...
        for (int x : nums) {
            // HERE WE ARE CHECKING THAT X-K CONTAINS IN HASHSET OR NOT IF IT CONTAINS THEN
            // WE ARE STORING IN RESULT AS A PAIR. IF NOT THEN WE ARE STORING THE NUMBER IN
            // HASHSET
