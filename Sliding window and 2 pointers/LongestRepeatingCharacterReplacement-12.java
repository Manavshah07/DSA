...
class Solution2 {
    public int characterReplacement(String s, int k) {
        ...
        while (j < n) {
            ...
            // HERE IF NEED TO CHANGE THE CHARACTER MORE THAN K THEN WE WILL START REMOVING
            // THE CHARACTER FROM START I.E I
            while ((j - i + 1) - maxFreq > k) {
                char ch1 = s.charAt(i);
                hmap.put(ch1, hmap.get(ch1) - 1);

                // HERE WE SHRINK OUR WINDOW BY REMOVING FIRST CHARACTER OF I OR FROM LEFT SIDE
                // AND AFTER THAT DOING I++ SO FOR THAT WE WILL RECALCUATE OUR MAXFREQ
                // recalculate maxFreq
                maxFreq = 0;
